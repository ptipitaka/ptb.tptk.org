...
lang: th
description: บันทึกทางวิชาการ — พระไตรปิฎกฉบับสำหรับประชาชน
outline: [2, 6]
prev: { text: 'เล่ม ๔๕ ปัฏฐาน ภาค ๖', link: '/part-4-tipitaka-digest/abhidhamma-pitaka/vol-45' }
next: { text: 'ภาค ๕ สารบัญค้นคำ', link: '/word-index/' }
searchKeywords:
  - บันทึกทางวิชาการ
  - พระไตรปิฎกฉบับสำหรับประชาชน
---

# ว่าด้วยบันทึกทางวิชาการ {#p5AcNotes01 .ptb-h-block}
