...
title: พระเถรี
lang: th
description: ดัชนีชื่อบุคคล — พระเถรี — สารบัญค้นคำ พระไตรปิฎกฉบับสำหรับประชาชน
outline: [2, 6]
prev: { text: 'พระเถระ', link: '/part-5-academic-notes-and-index/word-index/persons/thera/' }
next: { text: 'ผู้ครองนคร', link: '/part-5-academic-notes-and-index/word-index/persons/rulers/' }
searchKeywords:
  - ชื่อบุคคล
  - พระเถรี
  - สารบัญค้นคำ
...
## พระเถรี {#fxPm6PFWbX .ptb-h-block}

### พระเถรีสำคัญ {#O4aNnMh132 .ptb-h-block}

<PtbWordIndexEntry term="พระนางมหาปชาบดี โคตมี" desc="เลิศในทางรู้ราตรี/รัตตัญญู">
...
<PtbWordIndexEntry term="พระนางเขมา" desc="เลิศในทางมีปัญญามาก">
...
<PtbWordIndexEntry term="พระนางอุปปลวัณณา" desc="เลิศในทางมีฤทธิ์">
...
<PtbWordIndexEntry term="พระนางปฏาจารา" desc="เลิศในทางทรงจำพระวินัย">
...
<PtbWordIndexEntry term="พระนางภัททา กัจจานา หรือ พระนางยโสธรา" desc="เลิศในทางบรรลุอภิญญาใหญ่">
...
### พระเถรีรูปอื่น ๆ {#vflykcwmGp .ptb-h-block}

<PtbSubtitle>(เรียงตามอักษร)</PtbSubtitle>

#### ก {#jRmuftxK2W .ptb-h-block}

<PtbWordIndexEntry term="นางกิสาโคตมี" desc="เลิศในทางทรงจีวรสีหมอง">
...
<PtbWordIndexEntry term="พระนางกุณฑลเกสี" desc="เลิศในทางตรัสรู้ได้เร็ว">
...
#### จ {#1gbwz98S5V .ptb-h-block}

<PtbWordIndexEntry term="นางจัณฑกาลี" desc="ผู้มักโกรธเคืองและเป็นต้นบัญญัติสิกขาบทหลายข้อ (เช่น ห้ามสาปแช่งตนเองและผู้อื่น ห้ามทำร้ายตัวเองแล้วร้องไห้)">
...
#### ต {#X3U9WRv1e3 .ptb-h-block}

<PtbWordIndexEntry term="พระนางติสสา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้ศึกษาข้อที่ควรศึกษา และเปลื้องตนจากกิเลสเครื่องผูกมัด">
...
#### ถ {#QOTCBl7xem .ptb-h-block}

<PtbWordIndexEntry term="นางถุลลนันทาภิกษุณี" desc="ผู้เป็นต้นบัญญัติสิกขาบทมากมาย มักมีพฤติกรรมมักมากและก่อความยุ่งยากในหมู่คณะภิกษุณี">
...
#### ท {#IGONgtfHdx .ptb-h-block}

<PtbWordIndexEntry term="พระนางทันติกา" desc="ภิกษุณีผู้มีภาษิตเตือนใจ โดยอาศัยการเห็นช้างที่ถูกฝึกแล้วนำมาเป็นอุบายฝึกจิตตนเองจนตั้งมั่น">
...
#### ธ {#uFbRZFzjFu .ptb-h-block}

<PtbWordIndexEntry term="นางธัมมทินนา" desc="เลิศในทางแสดงธรรม">
...
<PtbWordIndexEntry term="พระนางธัมมา" desc="ภิกษุณีผู้มีภาษิตเตือนใจจากการล้มลงเพราะความชรา แล้วเห็นโทษของกายจนจิตหลุดพ้น">
...
#### น {#2xGZcQQbgm .ptb-h-block}

<PtbWordIndexEntry term="พระนางนันทา" desc="เลิศในทางเข้าฌาน">
...
#### ป {#BlJtbtnchX .ptb-h-block}

<PtbWordIndexEntry term="พระนางปุณณา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้ทำลายความมืดด้วยปัญญาอันบริบูรณ์ เหมือนดวงจันทร์วันเพ็ญ">
...
#### ภ {#zgCJBLW6P7 .ptb-h-block}

<PtbWordIndexEntry term="นางภัททา กาปิลานี" desc="เลิศในทางระลึกชาติได้">
...
#### ม {#wv8E0JE6th .ptb-h-block}

<PtbWordIndexEntry term="พระนางมิตตา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้เจริญกุศลธรรม เพื่อบรรลุธรรมอันปลอดโปร่งจากเครื่องผูกมัด">
...
#### ร {#HpDefMmuGC .ptb-h-block}

<PtbWordIndexEntry term="พระนางรูปนันทา" desc="ภิกษุณีผู้ที่พระพุทธเจ้าได้ตรัสพระพุทธภาษิตสอนใจไว้ในหมวดเถรีคาถา">
...
#### ส {#s0j5dE6Z0V .ptb-h-block}

<PtbWordIndexEntry term="นางสกุลา" desc="เลิศในทางมีทิพยจักษุ">
...
<PtbWordIndexEntry term="พระนางสังฆา" desc="ภิกษุณีผู้มีภาษิตเตือนใจถึงการละทิ้งเรือนและบุตรเพื่อเบื่อหน่ายอวิชชา และถอนตัณหาจนดับเย็น">
...
<PtbWordIndexEntry term="นางสิคาลมาตา" desc="เลิศในทางน้อมไปตามความเชื่อ">
...
<PtbWordIndexEntry term="นางสุนทรีนันทา" desc="รูปงามผู้เป็นต้นบัญญัติปาราชิกสิกขาบทแรกของภิกษุณี (เรื่องห้ามกำหนัดยินดีในการจับต้องของบุรุษ)">
...
<PtbWordIndexEntry term="พระนางสุมนา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้เห็นธาตุเป็นทุกข์ และคลายความพอใจในภพเพื่อความสงบ">
...
<PtbWordIndexEntry term="นางโสณา" desc="เลิศในทางปรารภความเพียร">
...
#### อ {#gCf2c5VK2i .ptb-h-block}

<PtbWordIndexEntry term="พระนางอภยมาตา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้พิจารณากายอันไม่สะอาด เพื่อถอนความกำหนัดและความเร่าร้อน">
...
<PtbWordIndexEntry term="พระอุตตรา" desc="ภิกษุณีผู้มีภาษิตเตือนใจถึงการสำรวมกายวาจาใจ และถอนตัณหาพร้อมทั้งราก">
...
<PtbWordIndexEntry term="พระนางอุปสมา" desc="ภิกษุณีผู้มีภาษิตเตือนใจให้ข้ามโอฆะและเอาชนะมาร เพื่อไม่ต้องเวียนว่ายตายเกิดอีก">
